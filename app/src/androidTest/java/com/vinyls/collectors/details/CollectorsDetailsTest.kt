...
var collectors: Array<Collector> = arrayOf(
    Collector(id = 100, name = "Manolo Bellon", telephone = "3502457896", email = "manollo@caracol.com.co",  collectorAlbums = listOf()),
    Collector(id = 101, name = "Jaime Monsalve", telephone = "3012357936", email = "jmonsalve@rtvc.com.co",  collectorAlbums = listOf()),
)
